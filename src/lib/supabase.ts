...
export const createClientOnServer = async () => {
  // Since we bypass Supabase Auth and manage sessions using a static admin cookie,
  // we use the admin client on the server to bypass RLS policies and ensure
  // database queries succeed reliably.
